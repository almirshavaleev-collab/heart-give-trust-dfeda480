...
const text = { fontSize: '15px', color: '#0B1F3A', lineHeight: 1.6, margin: '0 0 18px' }
const codeBox = { backgroundColor: '#F5F7FA', border: '1px solid #E5E9F0', borderRadius: '16px', padding: '24px', textAlign: 'center' as const, margin: '24px 0' }
const codeText = { fontSize: '34px', fontWeight: 700, letterSpacing: '8px', color: '#0B1F3A', margin: 0, fontFamily: 'monospace' }
const hint = { fontSize: '13px', color: '#5A6B82', lineHeight: 1.5, margin: '0 0 24px' }
