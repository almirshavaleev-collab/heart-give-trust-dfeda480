  ...
  <section id="contacts" className="py-24 md:py-32">
    <div className="container max-w-3xl">
      ...
      <div className="grid sm:grid-cols-3 gap-6 mb-10">
        <div className="glass-card rounded-2xl p-6 text-center card-elevated">
          <MapPin className="w-6 h-6 text-primary mx-auto mb-3" />
          <p className="text-xs text-muted-foreground mb-1">Адрес</p>
          <p className="text-sm font-medium">г. Альметьевск, ул. Ризы Фахретдина, 67</p>
        </div>
        <div className="glass-card rounded-2xl p-6 text-center card-elevated">
          <Phone className="w-6 h-6 text-primary mx-auto mb-3" />
          <p className="text-xs text-muted-foreground mb-1">Телефон</p>
          <a href="tel:+78553370480" className="text-sm font-medium hover:text-primary transition-colors">
            +7 (855) 337-04-80
          </a>
        </div>
        <div className="glass-card rounded-2xl p-6 text-center card-elevated">
          ...
          <a href="mailto:licey-1.alm@tatar.ru" className="text-sm font-medium hover:text-primary transition-colors">
            licey-1.alm@tatar.ru
          </a>
        </div>
      </div>

      <div className="glass-card rounded-3xl h-64 flex items-center justify-center">
